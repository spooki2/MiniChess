...
namespace AzumangaProject
{
    ...
    {
        public static Dictionary<Board, double> allChildBoards(Board board, Boolean botTurn, Boolean _ignoreMagi3_ = false,Boolean _respawnsCheck_ = false)
        {
